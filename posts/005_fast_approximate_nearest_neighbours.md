...
# arrowspace-rs: Fast (not approximate?) Nearest Neighbours
...
This was possible because of the improvements described in [the previous post](/posts/003_performance_improvements) and because the hardening of tests that made evident some limitations in the sampling strategy, now improved and better tested, and the clustering algorithm, now made more consistent (see below).
