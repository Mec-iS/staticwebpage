---
title: "ArrowSpace Performance Analysis: 100K Dimensions on Dorothea"
layout: blog_default
date: 2026-02-13
permalink: /posts/015_arrowspace_stress-test_on_dorothea_dataset/
categories: [arrowspace, vector-search, performance, graph-wiring]
excerpt: "Training Graph Wiring on the Dorothea dataset — speed, applications, and the connection between Rayleigh score and epiplexity"
---
...
## Acknoledgements
I gratefully acknowledge [Enverge Labs](https://www.enverge.ai/enverge-labs) for kindly providing the computation time used to run these experiments on their H100 GPU cluster powered by clean and cheap energy.