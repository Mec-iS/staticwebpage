---
title: "arrowspace: Capabilities, speed and accuracy"
layout: blog_default
date: 2026-02-17
permalink: /posts/016_arrowspace_performance_results/
categories: [arrowspace, vector-search, performance]
excerpt: "Testing all aspects of Graph Wiring on semantic data — how fast and accurate arrowspace is"
---
...
* There is a hint about `arrowspace`, despite being not a classification algorithm yet, performing better than UMAP on an 100K dataset in terms of classification.
