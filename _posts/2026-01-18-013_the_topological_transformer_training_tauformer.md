---
title: "The Topological Transformer: Training Tauformer (30M TauGPT runbook)"
layout: blog_default
date: 2026-01-18
permalink: /posts/013_the_topological_transformer_training_tauformer/
categories: [tauformer, transformers, attention, arrowspace, training]
excerpt: "Training notes for a 30M-class TauGPT run including the data pipeline, validation routing, and stabilization knobs"
---
...
The final run summary records `step=5000`, `best_val_loss=1.914555`, `current_lr_scale=0.03125`, and `total_tokens=655360000`. That is a good result for $$~2$$ hours of training on this smallest model (at an average of ~60K Tokens Per Second using ~7Gb of VRAM).
